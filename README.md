...
**คำสั่ง PM2 ที่ใช้บ่อย (สำหรับจัดการเซิร์ฟเวอร์):**
```bash
# ดูสถานะการทำงานของระบบทั้งหมด
pm2 status

# ดู Logs ข้อผิดพลาด (ถ้าเว็บล่มหรือเจอปัญหา)
pm2 logs wph-training

# รีสตาร์ทระบบใหม่ (ใช้หลังจากดึงโค้ดใหม่หรือเปลี่ยน .env)
pm2 restart wph-training

# หยุดการทำงานของระบบชั่วคราว
pm2 stop wph-training

# ลบระบบออกจาก PM2 (กรณีต้องการเคลียร์ทิ้งเพื่อเริ่มรันใหม่)
pm2 delete wph-training

# ลบทุกระบบที่รันค้างอยู่ใน PM2 ทั้งหมด
pm2 delete all
```
